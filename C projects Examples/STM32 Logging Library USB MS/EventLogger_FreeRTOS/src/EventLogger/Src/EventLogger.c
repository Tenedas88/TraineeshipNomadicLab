...
EventLogger_Status_TypeDef EventLogger_Init(EventLogger_Handle_TypeDef *plog, EventLogger_Interface_TypeDef *ploginterface){
	...
	if(Attached_Once == 0){
		...
		osThreadDef(LogCollector, LogCollector_Process_OS, LOGTASKPRIO, 0, LOGTASKSTACK);
...
/**
 * @brief Funzione di Deinizializzazione
 */
...
/**
 * @brief Funzione di formattazione della stringa
 */
